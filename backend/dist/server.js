...
async function bootstrap() {
    ...
    console.log(`Blockchain connected: network=${blockchain.network} chainId=${blockchain.chainId} contract=${blockchain.contractAddress} signer=${blockchain.signerAddress} latestBlock=${blockchain.latestBlock}`);
