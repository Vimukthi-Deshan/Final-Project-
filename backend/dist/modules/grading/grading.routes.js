...
router.post("/grading/predict", async (req, res) => {
    ...
    if (!parsed.success) {
        throw new HttpError(400, "INVALID_GRADING_PAYLOAD", "Grading payload is invalid", {
            issues: parsed.error.issues,
        });
    }
    const gradingServiceUrl = process.env.GRADING_SERVICE_URL ?? "http://127.0.0.1:8001";
    try {
        ...
        throw new HttpError(502, "GRADING_SERVICE_UNAVAILABLE", "Could not reach grading service", {
