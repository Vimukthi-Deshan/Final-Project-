...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface BatchRegistryProxyInterface extends Interface {
    getFunction(nameOrSignature: "admin" | "implementation" | "upgradeTo"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'upgradeTo', data: BytesLike): Result;
  ...
  export interface BatchRegistryProxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): BatchRegistryProxy;
    waitForDeployment(): Promise<this>;

    interface: BatchRegistryProxyInterface;
